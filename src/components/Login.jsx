  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-100 px-4">
        ...
        <div className="bg-white shadow-lg h-100 rounded-xl p-8 w-full max-w-md">
          ...
          <form className="space-y-4">
           ...
           <div className=" mt-5 flex justify-center">
             Don't have an account? <Link className="ml-2 text-lg text-amber-900" to='/sinup'>Sign Up</Link>
           </div>
        </div>
